...
import ThankYouPage from './components/ThankYouPage'; // IMPORT NEW PAGE
...
// ... (KEEP TRANSLATIONS & CONSTANTS EXACTLY AS THEY WERE) ...
const translations = {
  en: {
    name: "English",
...
const App = () => {
  ...
  useEffect(() => {
    ...
    // --- NEW LOGIC: Check if coming back from FormSubmit ---
    const params = new URLSearchParams(window.location.search);
    if (params.get('success') === 'true') {
        setLoading(false); // Skip loader
        setCurrentView('thankyou'); // Show Thank You Page
        // Clean URL so refresh doesn't stay on thank you
